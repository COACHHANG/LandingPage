...
function myFunction() {
  ...
  if (dots.style.opacity === "0") {
    ...
    }, 10); // Slight delay to ensure display is set before transition
  }
}


// control hiding effect for program page 
...
window.onload = function() {
  ...
  problemCards.forEach((card, index) => {
    setTimeout(() => {
      hiddenSection.classList.add('card-reveal');
    }, index * 300); // Stagger the animations by 200ms each
});
